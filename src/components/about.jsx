  ...
  return (
    <div className="flex flex-col md:flex-row text-xs mb-10">
      ...
      <div className="md:w-1/3 flex justify-center items-center px-4">
          <img className="rounded-lg grayscale cardm opacity-80" src={studio}></img>
      </div>
      ...
      <div className="md:w-2/3 flex justify-center items-center px-4">
        <div className="m-10 text-left">
          ...
          <p className="text-base mb-6">
            Alessia, scritta nel 1985. Torinese di nascita, sarda nel cuore.
            Ho un profondissimo legame con Torino e la sua malinconia danzante
            e con la Sardegna che non riesco a vivere quanto vorrei.
          </p>
          <p className="text-base mb-6">
           Sono una scrittrice a tempo perso e da poco una sviluppatrice web.
           La mia idea è quella di unire queste due grandi passioni per generare una forza unica che mi somigli il più possibile e poter portare passione e creatività in tutto ciò che faccio.<br />
          ...
          <p className="text-base mb-6">
            ...
            pensieri sono finiti nel cestino della carta.<br />
            Il codice mi sta aiutando a creare, per una volta, qualcosa che resti.
          </p>
